...
def txn_replay(session_filename, txn, proxy, result_queue, h2conn,request_IDs):
    ...
    try:
        ...
        if method == 'GET':
            #'Accept': '*/*','Referer': 'https://www.yahoo.com','Accept-Language': 'en-US',
            ...
            responseID = h2conn.request('GET',url=''+txn._uuid,
                                    headers={'Accept-Encoding': 'gzip, deflate','User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; rv:11.0) like Gecko/20100101 Firefox/12.0','Host': 'video-api.yql.yahoo.com','DNT': '1','Connection': 'Keep-Alive','Cache-Control': 'no-cache'})
